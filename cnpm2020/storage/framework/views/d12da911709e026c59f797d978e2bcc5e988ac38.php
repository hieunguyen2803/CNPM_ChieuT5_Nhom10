...
<!--<link rel="stylesheet" type="text/css" href="<?php echo e(asset('cssAuth/css/bootstrap.min.css')); ?>">-->
<!--<link rel="stylesheet" type="text/css" href="<?php echo e(asset('cssAuth/css/fontawsom-all.min.css')); ?>">-->
<!--<link rel="stylesheet" type="text/css" href="<?php echo e(asset('cssAuth/css/style.css')); ?>"/>-->
</head>
            ...
            <div class="col-sm-10 login-box">
                <div class="row">
                    <div class="col-lg-8 col-md-7 log-det">
                        ...
                        <div class="row">
                            <ul>
                                <li><a href="<?php echo e(route('redirect')); ?>"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="<?php echo e(route('redirect')); ?>"><i class="fab fa-google"></i></a></li>
...
<?php /**PATH D:\xampp\htdocs\cnpm2020\resources\views/page/login.blade.php ENDPATH**/ ?>